...
import { User, Mail, BookOpen, Users, Star, LogOut } from 'lucide-react';
          ...
          <Card className="md:col-span-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center">
                ...
                <span className="inline-block mt-2 px-3 py-1 text-xs font-semibold bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-full">
                  Instructor
                </span>
              </div>
